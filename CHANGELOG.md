...
### New feature
- If reduce charge limit difference between days is enabled, then continue charge session to reduce charge limit difference for tomorrow after achieving today's end time goal.
