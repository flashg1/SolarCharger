...
- Renamed "End on condition" switch to "Exit condition trigger". Please set switch to your desired setting.
- Renamed "Presence trigger" switch to "Device presence trigger". Please set switch to your desired setting.
