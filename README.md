...
- Support [charging multiple cars](https://github.com/flashg1/SolarCharger/wiki/Configuration#charge-mutiple-evs-at-the-same-time-based-on-power-allocation-weighting-for-each-car) and [loads]() at the same time based on priority and power allocation weighting for each car.
