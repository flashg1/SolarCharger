...
Integration APIs requiring paid subscription for most countries are marked with *.  Please see [charge current update period](https://github.com/flashg1/SolarCharger/wiki/Installation#charge-current-update-period) in relation to API polling interval.
