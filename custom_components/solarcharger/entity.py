...
class SolarChargerEntityType(Enum):
    ...
    TYPE_LOCAL_TESSIE = DOMAIN_TESSIE
    TYPE_LOCAL_TESLEMETRY = DOMAIN_TESLEMETRY
    TYPE_LOCAL_MYSKODA = DOMAIN_MYSKODA
    TYPE_LOCAL_BYD_VEHICLE = DOMAIN_BYD_VEHICLE
    TYPE_LOCAL_GWM_ORA = DOMAIN_GWM_ORA
    TYPE_LOCAL_KIA_UVO = DOMAIN_KIA_UVO
