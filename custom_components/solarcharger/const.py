...
CHARGER_DOMAIN_TESLA_BLE = "tesla_ble"
...
OPTION_CHARGEE_MIN_CHARGE_LIMIT = "chargee_min_charge_limit"
OPTION_CHARGEE_MAX_CHARGE_LIMIT = "chargee_max_charge_limit"
...
OPTION_GLOBAL_DEFAULT_VALUES: dict[str, Any] = {
    ...
    OPTION_CHARGEE_MIN_CHARGE_LIMIT: 50,
...
TESLA_BLE_DEFAULT_VALUES: dict[str, Any] = {
    OPTION_WAIT_CHARGEE_UPDATE_HA: 25,
}
...
CHARGE_API_DEFAULT_VALUES: dict[str, dict[str, Any | None]] = {
    ...
    CHARGER_DOMAIN_OCPP: {},
    CHARGER_DOMAIN_TESLA_CUSTOM: {},
    CHARGER_DOMAIN_TESLA_BLE: TESLA_BLE_DEFAULT_VALUES,
    CHARGER_DOMAIN_TESLA_FLEET: {},
    CHARGER_DOMAIN_TESLA_TESSIE: {},
}
...
OPTION_GLOBAL_DEFAULT_ENTITIES: dict[str, str] = {
    ...
    OPTION_CHARGEE_MIN_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGEE_MIN_CHARGE_LIMIT}",
    OPTION_CHARGEE_MAX_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGEE_MAX_CHARGE_LIMIT}",
    #####################################
    # Charge scheduling
    #####################################
    OPTION_CHARGE_LIMIT_MONDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_MONDAY}",
    OPTION_CHARGE_ENDTIME_MONDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_MONDAY}",
    OPTION_CHARGE_LIMIT_TUESDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_TUESDAY}",
    OPTION_CHARGE_ENDTIME_TUESDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_TUESDAY}",
    OPTION_CHARGE_LIMIT_WEDNESDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_WEDNESDAY}",
    OPTION_CHARGE_ENDTIME_WEDNESDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_WEDNESDAY}",
    OPTION_CHARGE_LIMIT_THURSDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_THURSDAY}",
    OPTION_CHARGE_ENDTIME_THURSDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_THURSDAY}",
    OPTION_CHARGE_LIMIT_FRIDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_FRIDAY}",
    OPTION_CHARGE_ENDTIME_FRIDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_FRIDAY}",
    OPTION_CHARGE_LIMIT_SATURDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_SATURDAY}",
    OPTION_CHARGE_ENDTIME_SATURDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_SATURDAY}",
    OPTION_CHARGE_LIMIT_SUNDAY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_LIMIT_SUNDAY}",
    OPTION_CHARGE_ENDTIME_SUNDAY: f"{TIME}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{OPTION_CHARGE_ENDTIME_SUNDAY}",
    #####################################
...
TESLA_BLE_ENTITIES: dict[str, str | None] = {
    OPTION_CHARGER_DEVICE_NAME: DEVICE_NAME_MARKER,
    OPTION_CHARGER_PLUGGED_IN_SENSOR: f"sensor.tesla_ble_{DEVICE_NAME_MARKER}_charge_cable",
    OPTION_CHARGER_CONNECT_TRIGGER_LIST: '["SAE", "IEC"]',
    OPTION_CHARGER_CONNECT_STATE_LIST: '["SAE", "IEC"]',
    OPTION_CHARGER_ON_OFF_SWITCH: f"switch.tesla_ble_{DEVICE_NAME_MARKER}_charger",
    OPTION_CHARGER_CHARGING_SENSOR: f"sensor.tesla_ble_{DEVICE_NAME_MARKER}_charging_state",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["Charging"]',
    OPTION_CHARGER_MAX_CURRENT: f"number.{DOMAIN}_{CONFIG_NAME_MARKER}_{OPTION_CHARGER_MAX_CURRENT}",
    OPTION_CHARGER_GET_CHARGE_CURRENT: f"number.tesla_ble_{DEVICE_NAME_MARKER}_charging_current",
    OPTION_CHARGER_SET_CHARGE_CURRENT: f"number.tesla_ble_{DEVICE_NAME_MARKER}_charging_current",
    OPTION_CHARGEE_SOC_SENSOR: f"sensor.tesla_ble_{DEVICE_NAME_MARKER}_battery_level",
    OPTION_CHARGEE_CHARGE_LIMIT: f"number.tesla_ble_{DEVICE_NAME_MARKER}_charging_limit",
    OPTION_CHARGEE_LOCATION_SENSOR: None,
    OPTION_CHARGEE_LOCATION_STATE_LIST: None,
    OPTION_CHARGEE_WAKE_UP_BUTTON: f"button.tesla_ble_{DEVICE_NAME_MARKER}_wake_up_car",
    OPTION_CHARGEE_UPDATE_HA_BUTTON: f"button.tesla_ble_{DEVICE_NAME_MARKER}_force_update_charge",
    CONTROL_CHARGER_ALLOCATED_POWER: f"number.{DOMAIN}_{CONFIG_NAME_MARKER}_{CONTROL_CHARGER_ALLOCATED_POWER}",
}
...
CHARGE_API_ENTITIES: dict[str, dict[str, str | None]] = {
    ...
    CHARGER_DOMAIN_TESLA_BLE: TESLA_BLE_ENTITIES,
