...
DOMAIN_MYSKODA = "myskoda"
DOMAIN_BYD_VEHICLE = "byd_vehicle"
DOMAIN_GWM_ORA = "gwm_ora"
DOMAIN_KIA_UVO = "kia_uvo"
DOMAIN_GEELY_CONNECT = "geely_connect"
DOMAIN_VOLVO = "volvo"
DOMAIN_MG_SAIC = "mg_saic"
...
DEVICE_MODEL_MAP: dict[str, str] = {
    ...
    DOMAIN_MYSKODA: f"{DOMAIN}-{DOMAIN_MYSKODA}",
    DOMAIN_BYD_VEHICLE: f"{DOMAIN}-{DOMAIN_BYD_VEHICLE}",
    DOMAIN_GWM_ORA: f"{DOMAIN}-{DOMAIN_GWM_ORA}",
    DOMAIN_KIA_UVO: f"{DOMAIN}-{DOMAIN_KIA_UVO}",
    DOMAIN_GEELY_CONNECT: f"{DOMAIN}-{DOMAIN_GEELY_CONNECT}",
...
ENTITY_CHARGER_STEP_CURRENT_LIST = "charger_step_current_list"
...
OPTION_COMMON_DEFAULT_VALUES: dict[str, Any] = {
    ...
    NUMBER_WAIT_DEVICE_LIMIT_CHANGE: 5,
    ...
    NUMBER_CHARGER_MIN_WORKABLE_POWER_PAUSE_THRESHOLD: 0,
    NUMBER_CHARGER_MIN_WORKABLE_POWER_RESUME_THRESHOLD: 10,
    NUMBER_CHARGER_PRIORITY: 8,
    NUMBER_CHARGER_POWER_ALLOCATION_WEIGHT: 1,
    NUMBER_DEVICE_MIN_CHARGE_LIMIT: 50,
    NUMBER_DEVICE_MAX_CHARGE_LIMIT: 100,
    #####################################
...
MYSKODA_DEFAULT_VALUES: dict[str, Any] = {
    SWITCH_POLL_CHARGER_UPDATE: DEFAULT_ON,
}
...
GEELY_CONNECT_DEFAULT_VALUES: dict[str, Any] = {}

VOLVO_DEFAULT_VALUES: dict[str, Any] = {
    SWITCH_POLL_CHARGER_UPDATE: DEFAULT_ON,
}

MG_SAIC_DEFAULT_VALUES: dict[str, Any] = {
    SWITCH_POLL_CHARGER_UPDATE: DEFAULT_ON,
}

USER_CUSTOM_DEFAULT_VALUES: dict[str, Any] = {
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT: 4,
    NUMBER_CHARGER_MIN_WORKABLE_POWER_PAUSE_THRESHOLD: -10.0,
    NUMBER_CHARGER_MIN_WORKABLE_POWER_RESUME_THRESHOLD: -5.0,
...
CHARGE_API_DEFAULT_VALUES: dict[str, dict[str, Any | None]] = {
    ...
    DOMAIN_TESLA_CUSTOM: TESLA_CUSTOM_DEFAULT_VALUES,
    SUBDOMAIN_MQTT_TESLA_BLE: TESLA_MQTTBLE_DEFAULT_VALUES,
    SUBDOMAIN_ESPHOME_TESLA_BLE: TESLA_ESPBLE_DEFAULT_VALUES,
    DOMAIN_TESLA_FLEET: TESLA_FLEET_DEFAULT_VALUES,
    DOMAIN_TESSIE: TESSIE_DEFAULT_VALUES,
    DOMAIN_TESLEMETRY: TESLEMETRY_DEFAULT_VALUES,
    DOMAIN_MYSKODA: MYSKODA_DEFAULT_VALUES,
    DOMAIN_BYD_VEHICLE: BYD_VEHICLE_DEFAULT_VALUES,
    DOMAIN_GWM_ORA: GWM_ORA_DEFAULT_VALUES,
    DOMAIN_KIA_UVO: KIA_UVO_DEFAULT_VALUES,
    DOMAIN_GEELY_CONNECT: GEELY_CONNECT_DEFAULT_VALUES,
    DOMAIN_VOLVO: VOLVO_DEFAULT_VALUES,
    DOMAIN_MG_SAIC: MG_SAIC_DEFAULT_VALUES,
...
DELETE_ENTITY_MARKER = ".deleteme"
# Use this to delete string from saved options, ie. 2 spaces
...
OPTION_GLOBAL_DEFAULT_ENTITIES: dict[str, str] = {
    ...
    # Wait times
    #####################################
    NUMBER_WAIT_DEVICE_WAKEUP: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{NUMBER_WAIT_DEVICE_WAKEUP}",
    NUMBER_WAIT_DEVICE_UPDATE_HA: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{NUMBER_WAIT_DEVICE_UPDATE_HA}",
    NUMBER_WAIT_DEVICE_LIMIT_CHANGE: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{NUMBER_WAIT_DEVICE_LIMIT_CHANGE}",
...
OCPP_CHARGER_ENTITIES: dict[str, str | None] = {
    ...
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
    ...
    NUMBER_CHARGER_MIN_WORKABLE_POWER_PAUSE_THRESHOLD: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MIN_WORKABLE_POWER_PAUSE_THRESHOLD}",
    NUMBER_CHARGER_MIN_WORKABLE_POWER_RESUME_THRESHOLD: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MIN_WORKABLE_POWER_RESUME_THRESHOLD}",
...
TESLA_CUSTOM_ENTITIES: dict[str, str | None] = {
    ...
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}battery",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charge_limit",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charge_limit",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}location_tracker",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
    ENTITY_DEVICE_WAKE_UP_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}wake_up",
    ENTITY_DEVICE_UPDATE_HA_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}force_data_update",
    # Non-configurable entities: Device specific entities
    # Configurable entities: Extra device specific entities
    NUMBER_CHARGER_MAX_SPEED: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_SPEED}",
    NUMBER_CHARGER_POWER_FACTOR: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_POWER_FACTOR}",
...
TESLA_MQTTBLE_ENTITIES: dict[str, str | None] = {
    ...
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}battery_level",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_limit",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_limit",
    ENTITY_DEVICE_LOCATION_SENSOR: None,
    OPTION_DEVICE_LOCATION_STATE_LIST: None,
    ENTITY_DEVICE_WAKE_UP_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}wake_up_car",
    ENTITY_DEVICE_UPDATE_HA_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}force_update_charge",
    # Non-configurable entities: Device specific entities
    # Configurable entities: Extra device specific entities
    NUMBER_WAIT_DEVICE_UPDATE_HA: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_WAIT_DEVICE_UPDATE_HA}",
    NUMBER_CHARGER_MAX_SPEED: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_SPEED}",
    NUMBER_CHARGER_POWER_FACTOR: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_POWER_FACTOR}",
    NUMBER_CHARGER_MIN_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MIN_CURRENT}",
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MIN_WORKABLE_CURRENT}",
...
TESLA_ESPBLE_ENTITIES: dict[str, str | None] = {
    ...
    ENTITY_CHARGER_SET_CHARGE_CURRENT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_amps",
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charge_level",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{SENSOR}.{DEVICE_NAME_MARKER}charge_limit",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_limit",
    ENTITY_DEVICE_LOCATION_SENSOR: None,
    OPTION_DEVICE_LOCATION_STATE_LIST: None,
    ENTITY_DEVICE_WAKE_UP_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}wake_up",
...
TESLA_FLEET_ENTITIES: dict[str, str | None] = {
    ...
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charge_limit",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charge_limit",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}location",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
    ENTITY_DEVICE_WAKE_UP_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}wake",
    ENTITY_DEVICE_UPDATE_HA_BUTTON: None,
    # Non-configurable entities: Device specific entities
    # Configurable entities: Extra device specific entities
    NUMBER_CHARGER_MAX_SPEED: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_SPEED}",
...
MYSKODA_ENTITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGER_CONNECT_TRIGGER_LIST: '["on"]',
    OPTION_CHARGER_CONNECT_STATE_LIST: '["on"]',
    ENTITY_CHARGER_ON_OFF_SWITCH: f"{SWITCH}.{DEVICE_NAME_MARKER}charging",
    # ["connect_cable", "ready_for_charging", "conserving", "charging", "charging_interrupted"]
    ENTITY_CHARGER_CHARGING_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charging_state",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["charging"]',
    NUMBER_CHARGER_MAX_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_CURRENT}",
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
...
BYD_VEHICLE_ENTITIES: dict[str, str | None] = {
    ...
    ENTITY_CHARGER_GET_CHARGE_CURRENT: None,
    ENTITY_CHARGER_SET_CHARGE_CURRENT: None,
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}elec_percent",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}location",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
...
GWM_ORA_ENTIITIES: dict[str, str | None] = {
    ...
    # ["disconnected", "connected", "charging", "awaiting_charging", "waiting_for_power", "error"]
    # ENTITY_CHARGER_CHARGING_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charging_status",
    # OPTION_CHARGER_CHARGING_STATE_LIST: '["charging"]',
    ENTITY_CHARGER_CHARGING_SENSOR: f"{BINARY_SENSOR}.{DEVICE_NAME_MARKER}charging_active",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["on"]',
    NUMBER_CHARGER_MAX_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_CURRENT}",
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
    ENTITY_CHARGER_GET_CHARGE_CURRENT: None,
    ENTITY_CHARGER_SET_CHARGE_CURRENT: None,
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}soc",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}location",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
...
KIA_UVO_ENTIITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGER_CONNECT_TRIGGER_LIST: '["on"]',
    OPTION_CHARGER_CONNECT_STATE_LIST: '["on"]',
    ENTITY_CHARGER_ON_OFF_SWITCH: f"{SWITCH}.{DEVICE_NAME_MARKER}ev_charging",
    ENTITY_CHARGER_CHARGING_SENSOR: f"{BINARY_SENSOR}.{DEVICE_NAME_MARKER}ev_battery_is_charging",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["on"]',
    NUMBER_CHARGER_MAX_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_CURRENT}",
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
    ENTITY_CHARGER_GET_CHARGE_CURRENT: None,
    ENTITY_CHARGER_SET_CHARGE_CURRENT: None,
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}ev_battery_percentage",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}ev_charge_limits_ac",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}ev_charge_limits_ac",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}location",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
    ENTITY_DEVICE_WAKE_UP_BUTTON: None,
    ENTITY_DEVICE_UPDATE_HA_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}force_refresh",
    # Non-configurable entities: Device specific entities
    # Configurable entities: Extra device specific entities
    NUMBER_CHARGER_MAX_SPEED: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_SPEED}",
    NUMBER_CHARGER_POWER_FACTOR: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_POWER_FACTOR}",
...
GEELY_CONNECT_ENTIITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGER_CONNECT_STATE_LIST: '["on"]',
    ENTITY_CHARGER_ON_OFF_SWITCH: f"{SWITCH}.{DEVICE_NAME_MARKER}charging",
    # ["Disconnected", "Plugged in", "Charging"]
    ENTITY_CHARGER_CHARGING_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charger_connected",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["Charging"]',
    NUMBER_CHARGER_MAX_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_CURRENT}",
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
    ENTITY_CHARGER_GET_CHARGE_CURRENT: None,
    ...
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
    ENTITY_DEVICE_WAKE_UP_BUTTON: None,
    ENTITY_DEVICE_UPDATE_HA_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}refresh_data",
    # Non-configurable entities: Device specific entities
    # Configurable entities: Extra device specific entities
    NUMBER_CHARGER_MAX_SPEED: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_SPEED}",
    NUMBER_CHARGER_POWER_FACTOR: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_POWER_FACTOR}",
...
VOLVO_ENTIITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGER_CONNECT_TRIGGER_LIST: '["connected"]',
    OPTION_CHARGER_CONNECT_STATE_LIST: '["connected"]',
    ENTITY_CHARGER_ON_OFF_SWITCH: None,
    # ["charging", "discharging", "done", "error", "idle", "scheduled"]
    ENTITY_CHARGER_CHARGING_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charging_status",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["charging"]',
    # NUMBER_CHARGER_MAX_CURRENT: f"{SENSOR}.{DEVICE_NAME_MARKER}charging_current_limit",
    NUMBER_CHARGER_MAX_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_CURRENT}",
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
    ENTITY_CHARGER_GET_CHARGE_CURRENT: None,
    ENTITY_CHARGER_SET_CHARGE_CURRENT: None,
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}battery_charge_level",
    # ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{SENSOR}.{DEVICE_NAME_MARKER}target_battery_charge_level",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}location",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
...
MG_SAIC_ENTIITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGER_CONNECT_STATE_LIST: '["on"]',
    ENTITY_CHARGER_ON_OFF_SWITCH: f"{SWITCH}.{DEVICE_NAME_MARKER}charging",
    # ["Unplugged", "Charging (AC)", "Charging Finished", "Charging", "Fault Charging", "Connecting",
    # "Unrecognized Connection", "Plugged In", "Charging Stopped", "Scheduled Charging", "Charging (DC)",
    # "Super Offboard Charging", "Charging", "V2X Discharging"]
    ENTITY_CHARGER_CHARGING_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charging_status",
    OPTION_CHARGER_CHARGING_STATE_LIST: '["Charging"]',
    NUMBER_CHARGER_MAX_CURRENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MAX_CURRENT}",
    # OPTION_CHARGER_STEP_CURRENT_LIST: "[0, 6, 8, 16]",
    ENTITY_CHARGER_STEP_CURRENT_LIST: f"{TEXT}.{DOMAIN}_{CONFIG_NAME_MARKER}_{ENTITY_CHARGER_STEP_CURRENT_LIST}",
    ENTITY_CHARGER_GET_CHARGE_CURRENT: f"{SENSOR}.{DEVICE_NAME_MARKER}charging_current",
    # ENTITY_CHARGER_SET_CHARGE_CURRENT: f"{SELECT}.{DEVICE_NAME_MARKER}charging_current_limit",
    ENTITY_CHARGER_SET_CHARGE_CURRENT: None,
    ENTITY_DEVICE_SOC_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}state_of_charge",
    # ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{SENSOR}.{DEVICE_NAME_MARKER}target_soc",
    ENTITY_DEVICE_GET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_SET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_DEVICE_CHARGE_LIMIT}",
    ENTITY_DEVICE_LOCATION_SENSOR: f"{DEVICE_TRACKER}.{DEVICE_NAME_MARKER}gps_location",
    OPTION_DEVICE_LOCATION_STATE_LIST: '["home"]',
    ENTITY_DEVICE_WAKE_UP_BUTTON: None,
    ENTITY_DEVICE_UPDATE_HA_BUTTON: None,
    # Non-configurable entities: Device specific entities
...
CHARGE_API_ENTITIES: dict[str, dict[str, str | None]] = {
    ...
    DOMAIN_MYSKODA: MYSKODA_ENTITIES,
    DOMAIN_BYD_VEHICLE: BYD_VEHICLE_ENTITIES,
    DOMAIN_GWM_ORA: GWM_ORA_ENTIITIES,
    DOMAIN_KIA_UVO: KIA_UVO_ENTIITIES,
    DOMAIN_GEELY_CONNECT: GEELY_CONNECT_ENTIITIES,
    DOMAIN_VOLVO: VOLVO_ENTIITIES,
    DOMAIN_MG_SAIC: MG_SAIC_ENTIITIES,
