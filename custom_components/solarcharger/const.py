...
NUMBER_CHARGER_MIN_WORKABLE_CURRENT_PAUSE_THRESHOLD = (
    "charger_min_workable_current_pause_threshold"  # 0 %
)
NUMBER_CHARGER_MIN_WORKABLE_CURRENT_RESUME_THRESHOLD = (
    "charger_min_workable_current_resume_threshold"  # 10 %
)
...
OPTION_COMMON_DEFAULT_VALUES: dict[str, Any] = {
    ...
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_PAUSE_THRESHOLD: 0,
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_RESUME_THRESHOLD: 10,
...
TESLA_CUSTOM_DEFAULT_VALUES: dict[str, Any] = {
...
USER_CUSTOM_DEFAULT_VALUES: dict[str, Any] = {
    ...
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_PAUSE_THRESHOLD: -10.0,
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_RESUME_THRESHOLD: -5.0,
...
OCPP_CHARGER_ENTITIES: dict[str, str | None] = {
    ...
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_PAUSE_THRESHOLD: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MIN_WORKABLE_CURRENT_PAUSE_THRESHOLD}",
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_RESUME_THRESHOLD: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_CHARGER_MIN_WORKABLE_CURRENT_RESUME_THRESHOLD}",
