...
DEVICE_MODEL_MAP: dict[str, str] = {
    ...
    DOMAIN_OCPP: f"{DOMAIN}_{DOMAIN_OCPP}",
    DOMAIN_TESLA_CUSTOM: f"{DOMAIN}_{DOMAIN_TESLA_CUSTOM}",
    SUBDOMAIN_MQTT_TESLA_BLE: f"{DOMAIN}_{MQTT_TESLA_BLE_MODEL}",
    SUBDOMAIN_ESPHOME_TESLA_BLE: f"{DOMAIN}_{ESPHOME_TESLA_BLE_MODEL}",
    DOMAIN_TESLA_FLEET: f"{DOMAIN}_{DOMAIN_TESLA_FLEET}",
    DOMAIN_TESLA_TESSIE: f"{DOMAIN}_{DOMAIN_TESLA_TESSIE}",
}
...
OPTION_CHARGEE_GET_CHARGE_LIMIT = "chargee_get_charge_limit"
OPTION_CHARGEE_SET_CHARGE_LIMIT = "chargee_set_charge_limit"
...
OCPP_CHARGER_ENTITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGEE_GET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{OPTION_CHARGEE_CHARGE_LIMIT}",
    OPTION_CHARGEE_SET_CHARGE_LIMIT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{OPTION_CHARGEE_CHARGE_LIMIT}",
...
TESLA_CUSTOM_ENTITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGEE_GET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charge_limit",
    OPTION_CHARGEE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charge_limit",
...
TESLA_MQTTBLE_ENTITIES: dict[str, str | None] = {
    ...
    OPTION_CHARGEE_GET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_limit",
    OPTION_CHARGEE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_limit",
    OPTION_CHARGEE_LOCATION_SENSOR: None,
    OPTION_CHARGEE_LOCATION_STATE_LIST: None,
...
TESLA_ESPBLE_ENTITIES: dict[str, str | None] = {
    OPTION_CHARGER_NAME: DEVICE_NAME_MARKER,
    OPTION_CHARGER_PLUGGED_IN_SENSOR: f"{SENSOR}.{DEVICE_NAME_MARKER}charge_port_latch_state",
    ...
    OPTION_CHARGEE_GET_CHARGE_LIMIT: f"{SENSOR}.{DEVICE_NAME_MARKER}charge_limit",
    OPTION_CHARGEE_SET_CHARGE_LIMIT: f"{NUMBER}.{DEVICE_NAME_MARKER}charging_limit",
    OPTION_CHARGEE_LOCATION_SENSOR: None,
    OPTION_CHARGEE_LOCATION_STATE_LIST: None,
    OPTION_CHARGEE_WAKE_UP_BUTTON: f"{BUTTON}.{DEVICE_NAME_MARKER}wake_up",
