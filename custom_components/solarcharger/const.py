...
NUMBER_MAX_CONSUMED_ENERGY = "max_consumed_energy"  # 7 kWh
...
OPTION_GLOBAL_DEFAULT_ENTITIES: dict[str, str] = {
    ...
    NUMBER_CHARGER_MIN_WORKABLE_CURRENT_EXIT_PAUSE_PERCENT: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_GLOBAL_DEFAULTS}_{NUMBER_CHARGER_MIN_WORKABLE_CURRENT_EXIT_PAUSE_PERCENT}",
}
...
OCPP_CHARGER_ENTITIES: dict[str, str | None] = {
    ...
    NUMBER_MAX_CONSUMED_ENERGY: f"{NUMBER}.{DOMAIN}_{CONFIG_NAME_MARKER}_{NUMBER_MAX_CONSUMED_ENERGY}",
}
