...
@pytest.mark.asyncio
async def test_async_allocate_net_power_to_2_devices_with_power_source_when_gross_power_is_negative(
    allocation_calls: dict[int, float],
) -> None:
    """A shortage that exceeds current consumption is dispatched to _bottom_up_release_power."""
    device_a = make_device_control(
    ...
    allocator = make_allocator(device_a, device_b, net_power=-100)
